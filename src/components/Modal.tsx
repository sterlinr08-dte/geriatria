...
export default function Modal({ open, title, onClose, children, footer }: ModalProps) {
  ...
  return createPortal(
    <div className="animate-modal-fondo fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/50 p-4 backdrop-blur-sm sm:items-center">
      <div className="animate-modal-panel flex max-h-[92vh] w-full max-w-2xl flex-col rounded-2xl bg-white ring-1 ring-amber-100 shadow-[0_28px_60px_-18px_rgba(84,132,180,0.38)]">
