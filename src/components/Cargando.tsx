// Indicador de carga: logo con pulso, aro teal que se expande (radar) y
// tres puntos teal en onda.
interface Props {
  texto?: string
  className?: string
}
  ...
  return (
    <div className={`flex flex-col items-center justify-center gap-4 py-12 ${className}`}>
      <div className="relative flex h-20 w-20 items-center justify-center">
        {/* Aros teal que se expanden (efecto radar) */}
        ...
        <img
          ...
          alt="Cargando"
          className="animate-carga-pulse relative h-14 w-14 rounded-full bg-white object-contain p-1 shadow-[0_6px_18px_-4px_rgba(13,148,136,0.5)] ring-1 ring-amber-100"
        />
      </div>
